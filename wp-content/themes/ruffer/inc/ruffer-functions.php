            ...
            echo '<div class="sidemenu-wrapper d-none d-lg-block ">';
                echo '<div class="sidemenu-content">';
                    ...
                    echo '<div class="widget woocommerce widget_shopping_cart">';
                        echo '<h3 class="widget_title">'.esc_html( 'Shopping cart', 'ruffer' ).'</h3>';
                    ...
                    echo '<div class="row justify-content-center justify-content-lg-between align-items-center gy-2">';
                        echo '<div class="col-auto d-none d-lg-block">';
                            echo '<div class="header-links">';
                                echo '<ul>';
                                    if(!empty($phone )){
                                        echo '<li><i class="far fa-phone"></i><b>Phone :</b><a href="'.esc_attr( 'tel:'.$phoneurl ).'">'.esc_html($phone).'</a></li>';
                                    }
                                    if(!empty($email )){
                                        echo '<li><i class="far fa-envelope"></i><b>Email :</b><a href="'.esc_attr( 'mailto:'.$eamilurl ).'">'.esc_html($email).'</a></li>';
                                    }
                                echo '</ul>';
                            echo '</div>';
                        echo '</div>';
