<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'type'     => 'color',
                'title'    => esc_html__( 'Theme Color', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Theme Color', 'ruffer' )
            ),
            array(
                'id'       => 'ruffer_map_apikey',
                'type'     => 'text',
                'title'    => esc_html__( 'Map Api Key', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Map Api Key', 'ruffer' ),
            ),
        )
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'ruffer_custom_bcktotop',
                'type'     => 'switch',
                'title'    => esc_html__( 'Custom Back To Top Button', 'ruffer' ),
                'subtitle' => esc_html__( 'If you select "Disabled", it will show default design for "back to top" button.', 'ruffer' ),
                'default'  => false,
                'on'       => esc_html__( 'Enabled', 'ruffer' ),
                'off'      => esc_html__( 'Disabled', 'ruffer' ),
            ...
            array(
                'id'       => 'ruffer_custom_bcktotop_icon',
                'type'     => 'text',
                'title'    => esc_html__( 'Custom Back To Top Button Icon', 'ruffer'),
                'subtitle' => esc_html__( 'Write Icon Class Here', 'ruffer'),
                'required' => array( 'ruffer_custom_bcktotop', 'equals', '1' ),
            ),
            array(
                'id'       => 'ruffer_bcktotop_bg_color',
                'type'     => 'color',
                'title'    => esc_html__( 'Back To Top Button Background Color', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Back to top button Background Color.', 'ruffer' ),
                'required' => array('ruffer_display_bcktotop','equals','1'),
            ...
            array(
                ...
                'type'     => 'color',
                'title'    => esc_html__( 'Back To Top Icon Color', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Back to top Icon Color.', 'ruffer' ),
                'required' => array('ruffer_display_bcktotop','equals','1'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'ruffer_header_social_icon_color',
                'type'     => 'color',
                'title'    => esc_html__( 'Header Social Icon Color', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Header Social Icon Color', 'ruffer' ),
                'output'   => array( 'color'    =>  '.header-social a' ),
                'required' => array( 'ruffer_header_topbar_social_icon_switcher', 'equals', '1' )
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(            
            array(
                'id'       => 'ruffer_menu_background',
                'type'     => 'media',
                'url'      => true,
                'title'    => esc_html__( 'Menu Bakcground Image', 'ruffer' ),
                'compiler' => 'true',
                'subtitle' => esc_html__( 'Upload your site Menu Bakcground Image for header ( recommendation png format ).', 'ruffer' ),
            ),
            array(
            ...
            array(
                'id'       => 'ruffer_header_submenu_border_top_color',
                'type'     => 'color',
                'title'    => esc_html__( 'Submenu Border Top Color', 'ruffer' ),
                'subtitle' => esc_html__( 'Set Submenu Border Top Color', 'ruffer' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'ruffer_post_details_related_post',
                'type'     => 'switch',
                'title'    => esc_html__('Related Post', 'ruffer'),
                'subtitle' => esc_html__('Control related post from here. If you use this option then you will able to show or hide related post ( Default setting Show ).', 'ruffer'),
                'on'        => esc_html__('Show','ruffer'),
                'off'       => esc_html__('Hide','ruffer'),
                'default'   => false,
            ),
    ...
    // -> START Gallery
    Redux::setSection( $opt_name, array(
        'title'      => esc_html__( 'Gallery', 'ruffer' ),
        'id'         => 'ruffer_gallery_widget',
        'icon'       => 'el el-gift',
        'fields'     => array(
            array(
                'id'          => 'ruffer_gallery_image_widget',
                'type'        => 'slides',
                'title'       => esc_html__('Add Gallery Image', 'ruffer'),
                'subtitle'    => esc_html__('Add gallery Image and url.', 'ruffer'),
                'show'        => array(
                    'title'          => false,
                    'description'    => false,
                    'progress'       => false,
   ...
   Redux::setSection( $opt_name, array(
       ...
       'fields'     => array(
            ...
            array(
               'id'       => 'ruffer_footer_widget_title_color',
               'type'     => 'color',
               'title'    => esc_html__( 'Footer Widget Title Color', 'ruffer' ),
               'required' => array('ruffer_footerwidget_enable','=','1'),
               'output'   => array( '.footer-custom-style h5' ),
            ),
            array(
               'id'       => 'ruffer_footer_widget_anchor_color',
               'type'     => 'color',
               'title'    => esc_html__( 'Footer Widget Anchor Color', 'ruffer' ),
               'required' => array('ruffer_footerwidget_enable','=','1'),
               'output'   => array( '.footer-custom-style a' ),
            ),
            array(
               'id'       => 'ruffer_footer_widget_anchor_hov_color',
               'type'     => 'color',
               'title'    => esc_html__( 'Footer Widget Anchor Hover Color', 'ruffer' ),
               'required' => array('ruffer_footerwidget_enable','=','1'),
