	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-title a'	=> '--white-color: {{VALUE}}!important;',
					'{{WRAPPER}} .project-card.style2 .project-content .project-subtitle'	=> '--theme-color: {{VALUE}}!important;',
				],
			]
        );
		...
		Group_Control_Typography::get_type(),
		 	[
				'name' 			=> 'overview_content_typography',
		 		...
		 		'selector' 	=> '{{WRAPPER}} .project-card .project-content .project-title a, {{WRAPPER}} .project-card.style2 .project-content .project-subtitle',
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-title a, {{WRAPPER}} .project-card.style2 .project-content .project-subtitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-title a, {{WRAPPER}} .project-card.style2 .project-content .project-subtitle' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
        );
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-subtitle'	=> '--theme-color: {{VALUE}}!important;',
				],
			]
        );
        $this->add_group_control(
		Group_Control_Typography::get_type(),
		 	[
				'name' 			=> 'counter_typography',
		 		'label' 		=> __( 'Typography', 'ruffer' ),
		 		'selector' 	=> '{{WRAPPER}} .project-card .project-content .project-subtitle',
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-subtitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .project-card .project-content .project-subtitle' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
        );
